...
public class AdministratorPage {
    ...
    private JFrame AdministratorPage;
    ...
    private void initialize() {
        AdministratorPage = new JFrame();
        AdministratorPage.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                System.out.print("MATA");
            }
        });
        AdministratorPage.setResizable(false);
        AdministratorPage.setIconImage(Toolkit.getDefaultToolkit().getImage(AdministratorPage.class.getResource("/images/pharmacy_80x80.png")));
        AdministratorPage.setTitle("Farmacia Ionas");
        AdministratorPage.setBounds(100, 100, 1024, 720);

        JPanel panel = new JPanel();
        panel.setBackground(Color.WHITE);
        AdministratorPage.getContentPane().add(panel, BorderLayout.CENTER);
        ...
        logo_farmacie.setIcon(new ImageIcon(AdministratorPage.class.getResource("/images/pharmacy_80x80.png")));
        ...
        logOff.setIcon(new ImageIcon(AdministratorPage.class.getResource("/images/log-in.png")));
        ...
        whiteCircleBg.setIcon(new ImageIcon(AdministratorPage.class.getResource("/images/white_circle_92.png")));
        whiteCircleBg.setBounds(924, 9, 82, 82);
        panel_1.add(whiteCircleBg);

        JLabel lblNewLabel = new JLabel("Meniu administrator");
        ...
        operatiune.setModel(new DefaultComboBoxModel(new String[] {"Selecteaza operatiunea", "Adauga farmacie", "Modifica farmacie", "Adauga angajat", "Modifica angajat", "Sterge angajat", "Adauga medicament"}));
        operatiune.setBounds(10, 11, 178, 35);
        panel_2.add(operatiune);

        JTextArea txtrCautatiProdusul = new JTextArea();
        txtrCautatiProdusul.setText(" 1. Selectati operatiunea \r\n dorita.\r\n\r\n 2. La selectarea operatiunii,\r\n tabelul se va actualiza \r\n conform entitatii pe care\r\n doriti sa operati!\r\n\r\n 3. Apasati \"executa\".\r\n\r\n 4. Introduceti datele cerute!\r\n\r\n 5. Finalizati!");
